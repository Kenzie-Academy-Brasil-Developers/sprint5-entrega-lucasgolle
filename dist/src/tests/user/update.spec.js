...
describe("Teste para metodo PATCH em /users/:id", () => {
    ...
    test("Tentando atualizar um usuário", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test("Tentando atualizar um usuário que não existe", () => __awaiter(void 0, void 0, void 0, function* () {
